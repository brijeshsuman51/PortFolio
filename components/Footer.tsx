...
const Footer: React.FC = () => {
  return (
    <footer className="bg-darker border-t border-gray-800 py-12">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href={`tel:${PROFILE.phone}`} className="text-gray-400 hover:text-white mt-1 hover:scale-110 transition-all">
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
    </svg>
  </a>
            <a href="mailto:brijeshsuman461@gmail.com" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="mt-8 text-center text-gray-600 text-sm">
          &copy; {new Date().getFullYear()} PortFolio. Built with React, Tailwind & Vite.
        </div>
      </div>
    </footer>
  );
